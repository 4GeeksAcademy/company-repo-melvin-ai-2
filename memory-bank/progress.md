...
## Completed
- Lighthouse audit (2026-09-17): Dev after plus **production** `next start`: website home/brasa-points mobile **97** (LCP 2.36s / 2.40s), desktop **100**. Backoffice login production **97 / 99**. Session cookie lets Overview SSR for LCP. Evidence in `audit/production/` and `audit/REPORT.md`.
